...
if __name__ == '__main__':
    try:
        ...
        def exc_ol_simple_blocks(block_name,gain_x,gain_y,bias_x,bias_y,ch=0):
            pattern_name = 'Pattern_4x4_blocks_60.mat'
            blk_pub.publish(block_name)
            print block_name
        ...
        def exc_cl_blocks(block_name,gain_x,gain_y,bias_x,bias_y,ch=0):    ####change this to closed loop stripe###
            pattern_name = 'Pattern_4x4_blocks_60.mat'
            blk_pub.publish(block_name)
            print block_name
        ...
        conditions[last_idx +0] = (exc_ol_blocks,'ol_blocks, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=1'%( 12, 0), ( 12,  0, 0, 0, 1))
        conditions[last_idx +1] = (exc_ol_blocks,'ol_blocks, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=1'%(-12, 0), (-12,  0, 0, 0, 1))
        conditions[last_idx +2] = (exc_ol_blocks,'ol_blocks, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=1'%( 0, 4),  ( 0,   4, 0, 0, 1))
        conditions[last_idx +3] = (exc_ol_blocks,'ol_blocks, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=1'%( 0,-4),  ( 0,  -4, 0, 0, 1))
        ...
        conditions[last_idx +10] = (exc_ol_blocks,'ol_blocks, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=0'%( 0,-4),  ( 0,  -4, 0, 0, 0))
        conditions[last_idx +11] = (exc_ol_blocks,'ol_blocks, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=0'%( 0, 0),  ( 0,   0, 0, 0, 0))
        conditions[last_idx +12] = (exc_ol_stripe,'ol_stripe, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=0'%( 70, 0), ( 70,  0, 0, 0, 0))
        conditions[last_idx +13] = (exc_ol_stripe,'ol_stripe, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=0'%(-70, 0), (-70,  0, 0, 0, 0))
        ###################################################################################
        ###################################################################################
