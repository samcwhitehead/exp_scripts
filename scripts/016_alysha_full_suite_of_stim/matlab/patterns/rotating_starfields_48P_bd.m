...
%modified 10/11/18 BHD & ADS to rotate bilaterally for all three directions
%% Define constants
% universe of points:
...
allPats(:,:,:,6) = frames;
%% Now calculate frames around translational axes
...
str = [directory_name '\Pattern_rotating_starfields_48P_bd'];
save(str, 'pattern');
