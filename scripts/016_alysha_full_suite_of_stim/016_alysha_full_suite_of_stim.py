...
if __name__ == '__main__':
    try:
        ...
        conditions[last_idx +2] = (exc_pitch_up,'pitch_up, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=0'%( 12, 0),  ( 6,  0, 0, 0, 0))
        conditions[last_idx +3] = (exc_pitch_down, 'pitch_down, g_x=%s, g_y=%s, b_x=0, b_y=0, ch=0'%( -12,0),  ( -6,  0, 0, 0, 0))
