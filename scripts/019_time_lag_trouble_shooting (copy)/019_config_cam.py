...
ca_camera_right = dynamic_reconfigure.client.Client('/ca_camera_right/camera_nodelet')
ca_camera_left = dynamic_reconfigure.client.Client('/ca_camera_left/camera_nodelet')

config = ca_camera_right.update_configuration({'trigger_mode':'mode1'})
config = ca_camera_left.update_configuration({'trigger_mode':'mode1'})

kine_camera = dynamic_reconfigure.client.Client('/kine_camera_1/camera_nodelet')
config = kine_camera.update_configuration({'trigger_mode':'mode14','enable_trigger':False,'frame_rate':50})
...
#
#config = c1.update_configuration({'frame_rate':25})
#config = c1.update_configuration({'frame_rate':25})
