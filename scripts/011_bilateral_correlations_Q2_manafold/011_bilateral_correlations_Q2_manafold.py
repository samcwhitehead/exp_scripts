...
fly_genotype = """w[1118]/+[HCS]; P{y[+t7.7] w[+mC]=GMR39E01-lexA}attP40,P{20XUAS-IVS-Syn21-OpGCamp6F-p10}su(Hw)attp5 /P{w[+mC]=BP-p65ADzpUw}attP40; pJFRC49-10XUAS-IVS-eGFPKir2.1 in attP2 (DL) / P{w[+mC]=BP-ZpGal4DBDUw}attP2"""
