...
fly_genotype = """w[1118]/+[HCS]; P{y[+t7.7] w[+mC]=GMR39E01-lexA}attP40,P{20XUAS-IVS-Syn21-OpGCamp6F-p10}su(Hw)attp5 /P{w[+mC]=GMR26B04-pBPp65ADZpUw)attP40; pJFRC49-10XUAS-IVS-eGFPKir2.1 in attP2 (DL) / P{w[+mC]=GMR39H12-pBPZpGDBDUw}attP2"""
