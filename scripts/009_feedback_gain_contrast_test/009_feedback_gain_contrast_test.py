...
exp_description = \
"""
Test positional component of muscle activation functions. Added contrast
variation to try and promote saccades at low contrast.
"""
...
if __name__ == '__main__':
    try:
        ...
        def exc_cl_full_HC(block_name,gain_x,bias_x):
            pattern_name = 'Pattern_full_1_HC.mat'
            bias_y = 0
            gain_y = 0
            blk_pub.publish(block_name)
            print block_name
	...
	def exc_cl_full_LC(block_name,gain_x,bias_x):
            pattern_name = 'Pattern_full_1_LC.mat'
            bias_y = 0
            gain_y = 0
            blk_pub.publish(block_name)
            print block_name
        ...
        conditions = {
                'cl_full_LC_bias=0':   (exc_cl_full_LC,  ('cl_full_LC_bias=0',   -3,   0)),
                
                'cl_full_LC_bias=-4':  (exc_cl_full_LC,  ('cl_full_LC_bias=-4',  -3,  -4)),
                'cl_full_LC_bias=4':   (exc_cl_full_LC,  ('cl_full_LC_bias=4',   -3,   4)),

                'cl_full_LC_bias=-16': (exc_cl_full_LC,  ('cl_full_LC_bias=-16', -3,  -16)),
                'cl_full_LC_bias=16':  (exc_cl_full_LC,  ('cl_full_LC_bias=16',  -3,   16)),

                'cl_full_HC_bias=0':   (exc_cl_full_HC,  ('cl_full_HC_bias=0',   -3,   0)),
                
                'cl_full_HC_bias=-4':  (exc_cl_full_HC,  ('cl_full_HC_bias=-4',  -3,  -4)),
                'cl_full_HC_bias=4':   (exc_cl_full_HC,  ('cl_full_HC_bias=4',   -3,   4)),

                'cl_full_HC_bias=-16': (exc_cl_full_HC,  ('cl_full_HC_bias=-16',  -3, -16)),
                'cl_full_HC_bias=16':  (exc_cl_full_HC,  ('cl_full_HC_bias=16',   -3,  16))}
