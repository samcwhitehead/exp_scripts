...
class bag2hdf5BR:
    ...
    def __init__(self,data_loc='/home/imager/work/data/muscle_imaging_integration_bagfiles',file_folder = 'toConvert',file_folder_out='hdf5_converted'):
        ...
        for file in os.listdir(file_folder):
            if file.endswith('.bag'):
                ...
                self.read_muscle_live_viewer_data('/live_viewer_left/b1')
                self.read_muscle_live_viewer_data('/live_viewer_left/b2')
                self.read_muscle_live_viewer_data('/live_viewer_left/b3')
                self.read_muscle_live_viewer_data('/live_viewer_left/bkg')
                self.read_muscle_live_viewer_data('/live_viewer_left/hg1')
                self.read_muscle_live_viewer_data('/live_viewer_left/hg2')
                self.read_muscle_live_viewer_data('/live_viewer_left/hg3')
                self.read_muscle_live_viewer_data('/live_viewer_left/hg4')
                self.read_muscle_live_viewer_data('/live_viewer_left/i1')
                self.read_muscle_live_viewer_data('/live_viewer_left/i2')
                self.read_muscle_live_viewer_data('/live_viewer_left/iii1')
                self.read_muscle_live_viewer_data('/live_viewer_left/iii24')
                self.read_muscle_live_viewer_data('/live_viewer_left/iii3')
                #self.read_muscle_live_viewer_data('/live_viewer_left/image_output')
                self.read_muscle_live_viewer_data('/live_viewer_left/nm')
                self.read_muscle_live_viewer_data('/live_viewer_left/pr')
                self.read_muscle_live_viewer_data('/live_viewer_left/tpd')
                self.read_muscle_live_viewer_data('/live_viewer_right/b1')
                self.read_muscle_live_viewer_data('/live_viewer_right/b2')
                self.read_muscle_live_viewer_data('/live_viewer_right/b3')
                self.read_muscle_live_viewer_data('/live_viewer_right/bkg')
                self.read_muscle_live_viewer_data('/live_viewer_right/hg1')
                self.read_muscle_live_viewer_data('/live_viewer_right/hg2')
                self.read_muscle_live_viewer_data('/live_viewer_right/hg3')
                self.read_muscle_live_viewer_data('/live_viewer_right/hg4')
                self.read_muscle_live_viewer_data('/live_viewer_right/i1')
                self.read_muscle_live_viewer_data('/live_viewer_right/i2')
                self.read_muscle_live_viewer_data('/live_viewer_right/iii1')
                self.read_muscle_live_viewer_data('/live_viewer_right/iii24')
                self.read_muscle_live_viewer_data('/live_viewer_right/iii3')
                #self.read_muscle_live_viewer_data('/live_viewer_right/image_output
                self.read_muscle_live_viewer_data('/live_viewer_right/nm')
                self.read_muscle_live_viewer_data('/live_viewer_right/pr')
                self.read_muscle_live_viewer_data('/live_viewer_right/tpd')
    ...
    def read_muscle_live_viewer_data(self, topic_name):
        ...
        print ('writing the muscle live_viewer data to hdf5')
        self.h5f.create_dataset(str(topic_name[1:])+'/musclelive_viewer_ros_tstamps',    data=ros_tstamps)
        self.h5f.create_dataset(str(topic_name[1:])+'/musclelive_viewer_tstamps',    data=tstamps)
        self.h5f.create_dataset(str(topic_name[1:])+'/musclelive_viewer_seq',    data=seq)
        self.h5f.create_dataset(str(topic_name[1:])+'/musclelive_viewer_value',    data=value)
        self.h5f.create_dataset(str(topic_name[1:])+'/musclelive_viewer_muscle',    data=muscle)
