...
genotype_nickname = raw_input('S-number:')
...
if __name__ == '__main__':
    try:
        ...
        conditions = {'cl_stripe':       (exc_cl,('Pattern_bar%s.mat',('',),'cl_stripe')),
                      ...
                      'ol_expand_center':(exc_ol_expand,('Pattern_expand.mat',21,'ol_expand_center')),
                      ...
                      'cs_stim_power_2': (exc_cs_stim,(pulse_voltages[2],'cs_stim_power_3')),
                      'cs_stim_power_3': (exc_cs_stim,(pulse_voltages[3],'cs_stim_power_4')),
                      'cs_stim_power_4': (exc_cs_stim,(pulse_voltages[4],'cs_stim_power_5')),
                      'cs_stim_power_5': (exc_cs_stim,(pulse_voltages[5],'cs_stim_power_6'))}
